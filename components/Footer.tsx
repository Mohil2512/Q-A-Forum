...
export default function Footer() {
  return (
    <footer className="w-full bg-black/80 border-t border-[#2e236c] shadow-lg mt-8 sm:mt-12">
      <div className="container-responsive py-4 sm:py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
          <div className="text-[#c8acd6] text-base sm:text-lg font-semibold">Anjaneya Corp.</div>
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            <span className="text-[#c8acd6] font-medium text-sm sm:text-base">Join Us:</span>
            <div className="flex flex-col xs:flex-row gap-2 xs:gap-3">
              <a 
                href="https://www.linkedin.com/in/mohil-pipaliya/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center gap-2 bg-[#17153b] hover:bg-[#2e236c] rounded-lg px-3 py-2 shadow hover:shadow-lg transition-all duration-300 text-sm sm:text-base w-full xs:w-auto"
              >
                <span className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-black">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 50 50" fill="none" className="sm:w-5 sm:h-5">
              ...
              <a 
                href="https://github.com/Mohil2512" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center gap-2 bg-[#17153b] hover:bg-[#2e236c] rounded-lg px-3 py-2 shadow hover:shadow-lg transition-all duration-300 text-sm sm:text-base w-full xs:w-auto"
              >
                <span className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-black">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white" className="sm:w-5 sm:h-5">
                    <path d="M12 2C6.477 2 2 6.484 2 12.021c0 4.428 2.865 8.184 6.839 9.504.5.092.682-.217.682-.482 0-.237-.009-.868-.014-1.703-2.782.605-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.004.07 1.532 1.032 1.532 1.032.892 1.53 2.341 1.088 2.91.832.091-.647.35-1.088.636-1.339-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.987 1.029-2.686-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.025A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.295 2.748-1.025 2.748-1.025.546 1.378.203 2.397.1 2.65.64.699 1.028 1.593 1.028 2.686 0 3.847-2.338 4.695-4.566 4.944.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.744 0 .267.18.579.688.481C19.138 20.203 22 16.447 22 12.021 22 6.484 17.523 2 12 2z"/>
                  </svg>
                </span>
              ...
              <a 
                href="https://discord.gg/zDnFfbuJVN" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center gap-2 bg-[#17153b] hover:bg-[#2e236c] rounded-lg px-3 py-2 shadow hover:shadow-lg transition-all duration-300 text-sm sm:text-base w-full xs:w-auto"
              >
        ...
        {/* Copyright */}
        <div className="border-t border-[#2e236c]/50 mt-4 sm:mt-6 pt-3 sm:pt-4 text-center">
          <p className="text-[#c8acd6]/70 text-xs sm:text-sm">
            © 2024 StackIt. All rights reserved. Built with ❤️ by Anjaneya Corp.
          </p>
        </div>
      </div>
    </footer>
